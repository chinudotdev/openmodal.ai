...
export const Route = createFileRoute('/admin/drafts/organizations/')({
  component: AdminOrganizationsDraftsPage,
  loader: async () => {
...
function AdminOrganizationsDraftsPage() {
  ...
  return (
    <main className="container mx-auto px-6 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold mb-2">Organization Drafts</h1>
        <p className="text-muted-foreground">
          Review and manage draft changes to organizations
        </p>
      </div>
