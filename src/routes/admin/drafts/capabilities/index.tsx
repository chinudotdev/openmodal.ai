...
export const Route = createFileRoute('/admin/drafts/capabilities/')({
  component: AdminCapabilitiesDraftsPage,
  loader: async () => {
...
function AdminCapabilitiesDraftsPage() {
  ...
  return (
    <main className="container mx-auto px-6 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold mb-2">Capability Drafts</h1>
        <p className="text-muted-foreground">
          Review and manage draft changes to AI capabilities
        </p>
      </div>
