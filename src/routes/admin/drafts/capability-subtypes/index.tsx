...
export const Route = createFileRoute('/admin/drafts/capability-subtypes/')({
  component: AdminCapabilitySubtypesDraftsPage,
  loader: async () => {
...
function AdminCapabilitySubtypesDraftsPage() {
  ...
  const fetchDrafts = async () => {
    ...
    try {
      ...
      console.log(
        '[capability-subtypes page] Received drafts:',
        result.draftChanges,
      )
      console.log(
        '[capability-subtypes page] First draft entity type:',
    ...
    <main className="container mx-auto px-6 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold mb-2">
          Capability Subtype Drafts
        </h1>
        <p className="text-muted-foreground">
          Review and manage draft changes to domain-specific capabilities
        </p>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Capability Subtype</TableHead>
