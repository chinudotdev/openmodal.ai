...
interface BarrierStep1Props {
  // @ts-expect-error - TanStack Form type compatibility
  form: FormApi<Partial<BarrierReportInput>>;
  onNext: () => void;
  onUpdate: (data: BarrierReportInput["step1"]) => void;
}

export function BarrierStep1({ form, onNext, onUpdate }: BarrierStep1Props) {
          ...
          children={(field: any) => {
            ...
            return (
              <JobAutocompleteInput
                ...
                label="What job or task is being prevented from automation?"
                required
            ...
            return (
              <Field data-invalid={isInvalid}>
                ...
                <Input
                  ...
                  placeholder="e.g., Autonomous vehicles, AI medical diagnosis"
